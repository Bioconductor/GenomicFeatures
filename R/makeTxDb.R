...
#' 
#' @param transcripts Data frame containing the genomic locations of a set of
#' transcripts.
#' @param splicings Data frame containing the exon and CDS locations of a set
#' of transcripts.
#' @param genes Data frame containing the genes associated to a set of
#' transcripts.
#' @param chrominfo Data frame containing information about the chromosomes
#' hosting the set of transcripts.
#' @param metadata 2-column data frame containing meta information about this
...
#' character.
#' @param reassign.ids \code{TRUE} or \code{FALSE}.  Controls how internal ids
...
#' @param on.foreign.transcripts Controls what to do when the input contains
