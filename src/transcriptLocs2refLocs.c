...
static SEXP transcript_widths(SEXP exonStarts, SEXP exonEnds, int ref_length)
{
...
SEXP C_transcript_widths(SEXP exonStarts, SEXP exonEnds)
{
	return transcript_widths(exonStarts, exonEnds, -1);
}

SEXP C_tlocs2rlocs(SEXP tlocs, SEXP exonStarts, SEXP exonEnds,
