...
Bioinformatics transcript tracks (e.g. \Rcode{"knownGene"},
\Rcode{"refGene"}, \code{"ensGene"}) for a genome build (e.g.
\code{"mm9"}, \code{"hg19"}).

<<makeTranscriptDbFromUCSC>>=
mm9KG <- makeTranscriptDbFromUCSC(genome = "mm9", track = "knownGene")
mm9KG
@
