...
\section{Retrieving range data as GRanges and GRangesList objects}
...
%% TODO: lets add some exercises to the following descriptions.

%% HINT: the bottom IDs are on chr15.
w
...
If you then wanted to only set Chromosome 15 to be active you could do
it like this:
<<isActive2>>=
...
%% TODO: Remove MOST of this subsection, and just move the definition of gr down below...
...
%% TODO: 
%% This "practical" section (below) feels useless and dated.  Remove?  Or just simplify to prose the mentions things like findOverlaps() etc.  Or (most appealing) just mention those functions as the impetus above in the intro to this section???
...
%% TODO:  Add a section to show how to used translate() etc.
%% TODO: update all the examples to use a smaller set of examples and annots.
